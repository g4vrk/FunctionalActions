...
[![Version](https://img.shields.io/badge/version-2.1.2-informational)](.)
...
```kotlin
dependencies {
    implementation("com.github.g4vrk:FunctionalActions:2.1.2")
}
```
...
> [!IMPORTANT]
> JitPack собирает библиотеку прямо из GitHub. Перед использованием `2.1.2` в репозитории должен существовать соответствующий Git-тег/релиз.
